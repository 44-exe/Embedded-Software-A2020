...
bool FTM_Init()
{
  ...
  FTM0->SC |= FTM_SC_CLKS(0b10) | FTM_SC_PS(0b111); //set prescale factor of 128
...
void FTM0_IRQHandler(void)
{
  ...
  {
    if ((FTM0->CONTROLS[channel].CnSC & FTM_CnSC_CHIE_MASK) && (FTM0->CONTROLS[channel].CnSC & FTM_CnSC_CHF_MASK))
    {
